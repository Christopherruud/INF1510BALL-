 ...
 * Libraries used that are not included in the main 
 * Arduino IDE are available for download from within the
 * GITHUB project folder libraries/
 **/
...
String getGyroData() {
  ...
  float dt =(timeStamp - get_last_time())/1000.0;
